...
export const Pagination = (props: IPaginationProps) => {
  ...
  const renderPage = (curPage, i) => (
    <div
      key={i}
      className={cn('uikit__btn-light uikit__btn-light_sm', {
        'uikit__btn-light_active': curPage === page,
      })}
  ...
  return (
    <div className={cn('flex items-center', className)}>
      <div className="flex gap-x-2">
        <div
          className={cn('uikit__btn-light uikit__btn-light_sm', {
            'uikit__btn-light_disabled': !isPrevPageAvailable,
            'uikit__text-secondary': isPrevPageAvailable,
          })}
          onClick={prevPage}
        >
          <i className="fa fa-angle-left uikit__fa uikit__fa_noColor"></i>
        </div>
        ...
        <div
          className={cn('uikit__btn-light uikit__btn-light_sm', {
            'uikit__btn-light_disabled': !isNextPageAvailable,
            'uikit__text-secondary': isNextPageAvailable,
          })}
          onClick={nextPage}
        >
          <i className="fa fa-angle-right uikit__fa uikit__fa_noColor"></i>
        </div>
      </div>
      ...
      <div className="ml-4">
        <Select
          ...
          searchable={false}
          placeholder=""
          inputClass="uikit__input-secondary uikit__input-secondary_hover text-sm w-24"
          popupClass={s.popup}

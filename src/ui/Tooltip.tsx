...
import { ITooltipContext } from '../lib/types.js';
import { Portal } from '../lib/utils.jsx';
...
const TooltipContext = createContext<ITooltipContext>(null as any);
...
export const TTrigger = ({ children }) => {
  const { refs, getReferenceProps, className } = useContext(TooltipContext);
  return (

...
import { makeCaseInsensitiveRegex, useMergeState } from '../lib/utils.jsx';
  ...
  return (
    <div className={className}>
      <input
        data-test="input"
        type="text"
        className={cn(inputClass || 'uikit__input', { 'cursor-pointer': !searchable })}
        ...
        <div data-test="popup" className={popupClass || s.popup} onMouseDown={preventFocusLoosing}>
          ...
          {isEmpty(filteredOptions) && (
            <div className={cn(s.option, s.option_nothingFound)}>
              ...
              {isFunction(nothingFound) && createElement(nothingFound)}

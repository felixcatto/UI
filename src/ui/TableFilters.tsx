...
import { useMergeState } from '../lib/utils.jsx';
...
export const SearchFilter = (props: ISearchFilterProps) => {
  ...
  return (
    <>
      <input
        type="text"
        className="uikit__input mb-4 w-52"
        placeholder="Search"
      ...
      <div className="flex items-center justify-between">
        <div
          className={cn('uikit__link text-sm mr-5', { uikit__link_disabled: !filter })}
          onClick={onResetOwnFilter}
        >
          Reset
        </div>
        <button
          className="uikit__btn uikit__btn_primary uikit__btn_sm rounded-md"
...
export const SelectFilter = (props: ISelectFilterProps) => {
  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between">
        <div
          className={cn('uikit__link text-sm mr-5', { uikit__link_disabled: isEmpty(filter) })}
          onClick={onResetOwnFilter}
        >
          Reset
        </div>
